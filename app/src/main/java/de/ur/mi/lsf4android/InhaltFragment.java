...
public class InhaltFragment extends android.support.v4.app.Fragment {
    ListView inhalt;
    ...
    private class DownloadDetailsTask extends AsyncTask<String, Integer, String[][]> {
        ...
        protected void onPostExecute(String[][] result) {
            ...
            if (context != null) {
                GrunddatenArrayAdapter arrayAdapter = new GrunddatenArrayAdapter(context, R.layout.row_inhalt, result);
